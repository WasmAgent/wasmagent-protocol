...
| #21 | [milestone Milestone 4 ] Update README + `docs/CONTRACT-C... | completed/complexity_gate_split | 2026-07-23 |
...
- #30: [milestone Milestone 2 ] In `open-agent-audit`, add an adapter mapping `schemas/v0.1/canonical-event.sche...
- #29: Fix WasmAgent/wasmagent-protocol#23 ([milestone Milestone 2 ] Add a CI step in `wasmagent-proxy` that validates emitted 
